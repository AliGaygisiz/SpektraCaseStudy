...
namespace SpektraCaseStudy.Migrations
{
    /// <inheritdoc />
    public partial class InitialRefactored : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    TenantId = table.Column<string>(type: "text", nullable: false, defaultValue: "False"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstTs = table.Column<long>(type: "bigint", nullable: false),
                    FirstValue = table.Column<double>(type: "double precision", nullable: false),
                    LastTs = table.Column<long>(type: "bigint", nullable: false),
                    LastValue = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAggregates", x => new { x.TenantId, x.UserId, x.EventName });
                });
